...
export default function FestivalAlert({ festivals }: FestivalAlertProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-5 sm:p-6 border border-purple-100 shadow-sm overflow-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="space-y-4">
          {festivals.map((festival, index) => (
            <div key={index} className="bg-white/60 backdrop-blur-sm rounded-xl p-4 border border-purple-100 flex flex-col sm:flex-row gap-4 items-start hover:shadow-md transition-shadow cursor-default">
